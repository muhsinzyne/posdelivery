...
class RegisterCloseSummary {
  ...
  RegisterCloseSummary.fromJson(Map<String, dynamic> json) {
    ...
    ccSales = json['ccsales'] != null ? CcSales.fromJson(json['ccsales']) : null;
    cashSales = json['cashsales'] != null ? CashSales.fromJson(json['cashsales']) : null;
    chSales = json['chsales'] != null ? ChSales.fromJson(json['chsales']) : null;
    gCSales = json['gcsales'] != null ? ChSales.fromJson(json['gcsales']) : null;
    pppSales = json['pppsales'] != null ? ChSales.fromJson(json['pppsales']) : null;
    stripeSales = json['stripesales'] != null ? ChSales.fromJson(json['stripesales']) : null;
    authorizeSales = json['authorizesales'] != null ? ChSales.fromJson(json['authorizesales']) : null;
    totalSales = json['totalsales'] != null ? CashSales.fromJson(json['totalsales']) : null;
    refunds = json['refunds'] != null ? Refunds.fromJson(json['refunds']) : null;
    returns = json['returns'] != null ? Returns.fromJson(json['returns']) : null;
    cashRefunds = json['cashrefunds'] != null ? Refunds.fromJson(json['cashrefunds']) : null;
    expenses = json['expenses'] != null ? Returns.fromJson(json['expenses']) : null;
