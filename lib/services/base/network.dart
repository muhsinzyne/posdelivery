...
class DioNetwork extends BaseGetXService {
  ...
  Future<Response> post(String url, {Map<String, dynamic> data, Map<String, dynamic> queryParameters}) {
    data ??= emptyRequest;
    queryParameters ??= emptyRequest;
    return dio.post(url, data: data, queryParameters: queryParameters);
  }

  Future<Response> put(String url, {Map<String, dynamic> data, Map<String, dynamic> queryParameters}) {
    data ??= emptyRequest;
    queryParameters ??= emptyRequest;
    return dio.put(url, data: data, queryParameters: queryParameters);
  }

  Future<Response> patch(String url, {Map<String, dynamic> data, Map<String, dynamic> queryParameters}) {
    data ??= emptyRequest;
    queryParameters ??= emptyRequest;
