...
class _PrintViewViewState extends State<PrintViewView> {
  ...
  printInvoice() async {
    ...
    list.add(
        LineText(type: LineText.TYPE_TEXT, content: 'Simple Tax Invoice', weight: 2, align: LineText.ALIGN_CENTER, linefeed: 1, size: 18));
    list.add(LineText(
        type: LineText.TYPE_TEXT, content: 'Date: 12/12/2021 19:45', weight: 2, align: LineText.ALIGN_LEFT, linefeed: 1, size: 14));
    list.add(LineText(
        type: LineText.TYPE_TEXT, content: 'Sale No/Ref: SALE00000014', weight: 2, align: LineText.ALIGN_LEFT, linefeed: 1, size: 14));
    list.add(LineText(
        type: LineText.TYPE_TEXT, content: 'Sale No/Ref: SALE00000014', weight: 2, align: LineText.ALIGN_LEFT, linefeed: 1, size: 14));
    list.add(LineText(
        type: LineText.TYPE_TEXT,
        ...
        size: 14));
    list.add(LineText(
        type: LineText.TYPE_TEXT, content: 'Customer: Walk In-customer', weight: 2, align: LineText.ALIGN_LEFT, linefeed: 1, size: 14));
    list.add(LineText(type: LineText.TYPE_TEXT, content: 'ITEMS', weight: 2, align: LineText.ALIGN_CENTER, linefeed: 1, size: 18));
    list.add(LineText(
        type: LineText.TYPE_TEXT,
        content: '------------------------------------',
        weight: 2,
      ...
      floatingActionButton: StreamBuilder<bool>(
        ...
        builder: (c, snapshot) {
          if (snapshot.data) {
            ...
            return FloatingActionButton(
                child: Icon(Icons.search), onPressed: () => bluetoothPrint.startScan(timeout: Duration(seconds: 4)));
          }
        },
      ),
    );
