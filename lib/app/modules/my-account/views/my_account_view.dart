                                                          ...
                                                          children: [
                                                            Container(
                                                              ...
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  TextButton(
                                                                    onPressed: controller.cancelDateChange,
                                                                    child: Text('cancel'.tr),
                                                                  ),
                                                                  TextButton(
                                                                    onPressed: controller.updateSearchDate,
                                                                    child: Text('done'.tr),
                                                                  )
                                                                ],
                                                              ),
                                                            ...
                                                            Container(
                                                              child: CupertinoDatePicker(
                                                                ...
                                                                onDateTimeChanged: (DateTime newDateTime) {
                                                                  controller.cChangeDate = newDateTime;
                                                                },
                                                              ),
                                                              height: 200,
                                                              color: Colors.white,
                                  ...
                                  Container(
                                    ...
                                    itemBuilder: (context, i) {
                                      return Container(
                                        ...
                                        decoration: BoxDecoration(
                                          gradient: LinearGradient(stops: [0.02, 0.02], colors: [AppColors.primary, Colors.white]),
