                                  ...
                                  child: Container(
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        cCustomerData.isOverPaid
                                            ? Text(
                                                cCustomerData.dueAccount.toStringAsFixed(2),
                                                style: kBaseTextStyle.copyWith(
                                                  fontWeight: FontWeight.bold,
                                                  color: Colors.green,
                                                  fontSize: 22,
                                            ...
                                            : Text(
                                                ...
                                                style: kBaseTextStyle.copyWith(
                                                  fontWeight: FontWeight.bold,
                                                  color: cCustomerData.isDue ? Colors.red : AppColors.secondary,
                                                  fontSize: 22,
                                                ),
                                              ),
                                      ],
                                ...
                                Expanded(
                                  ...
                                  child: Container(
                                    child: CElevatedButton(
                                      onPress: () {
                                        controller.actionOnSalesList(cCustomerData);
                                      },
                                      label: 'sales'.tr,
                                      fontSize: 16,
                                    ),
