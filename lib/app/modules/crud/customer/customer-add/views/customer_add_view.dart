...
class CustomerAddView extends GetView<CustomerAddController> {
                      ...
                      children: [
                        Container(
                          child: DropdownButtonFormField<CustomerGroups>(
                            ...
                            items: (controller.customerPriceGroup.value.customerGroups?.map(buildCustomerGroup) ?? []).toList(),
                        ...
                        Container(
                          child: DropdownButtonFormField<PriceGroups>(
                            ...
                            items: (controller.customerPriceGroup.value.priceGroups?.map(buildPriceGroupItem) ?? []).toList(),
                        ...
                        UserInputStyle2(
                          ...
                          onFieldSubmitted: (String value) {
                            controller.nextFocus(controller.phoneFocus, context);
                          },
                        ...
                        UserInputStyle2(
                          ...
                          onFieldSubmitted: (String value) {
                            controller.nextFocus(controller.emailFocus, context);
                          },
                        ...
                        UserInputStyle2(
                          ...
                          onFieldSubmitted: (String value) {
                            controller.nextFocus(controller.addressFocus, context);
                          },
                        ...
                        UserInputStyle2(
                          ...
                          onFieldSubmitted: (String value) {
                            controller.nextFocus(controller.stateFocus, context);
                          },
                        ...
                        UserInputStyle2(
                          ...
                          onFieldSubmitted: (String value) {
                            controller.nextFocus(controller.countryFocus, context);
                          },
  ...
  DropdownMenuItem<CustomerGroups> buildCustomerGroup(CustomerGroups item) => DropdownMenuItem(
        value: item,
        child: Text(
  ...
  DropdownMenuItem<PriceGroups> buildPriceGroupItem(PriceGroups item) => DropdownMenuItem(
        value: item,
        child: Text(
          item.name.toString().toUpperCase(),
        ),
