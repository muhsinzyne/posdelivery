...
class CustomerAddController extends BaseGetXController implements ICustomerAddController {
  ...
  actionOnSaveRequest() {
    if (addFromKey.currentState.validate()) {
      ...
      UINotification.showNotification(color: Colors.red, title: 'please_complete_form'.tr);
    }
  }
