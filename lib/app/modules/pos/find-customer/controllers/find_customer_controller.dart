...
class FindCustomerScreenController extends BaseGetXController implements IFindCustomerScreenController {
  ...
  void onScannedResult(String value) {
    if (value != null) {
      final CustomerInfo tempCInfo = customerList.firstWhere((element) => element.id == value);
      cCustomer.value = tempCInfo.id;
      selectedCustomerName.value = "[${tempCInfo.id.toString()}]  ${tempCInfo.value.toString()}";
    }
  }
