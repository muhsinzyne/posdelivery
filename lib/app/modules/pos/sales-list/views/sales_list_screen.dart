    ...
    return Scaffold(
      ...
      body: Obx(() {
        return ListView.builder(
          ...
          itemCount: controller.isLoading.isTrue ? controller.salesList.length + 1 : controller.salesList.length,
                                          ...
                                          child: Container(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  controller.sr.formatCurrency(double.tryParse(cSales.grandTotal)),
                                                  style: kBaseTextStyle.copyWith(
                                                    fontWeight: FontWeight.bold,
                                                    color: AppColors.secondary,
                                                    fontSize: 18,
                                          ...
                                          child: Container(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  controller.sr.formatCurrency(double.tryParse(cSales.balance ?? '0.0')),
