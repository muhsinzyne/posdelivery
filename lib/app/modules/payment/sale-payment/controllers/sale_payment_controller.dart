...
class SalePaymentController extends BaseGetXController implements ISalePaymentController {
  ...
  _autoFillData() {
    invoiceTotalAmount.text = salePaymentNavParams.value.invoiceTotal.toStringAsFixed(2);
    dueAmount.text = salePaymentNavParams.value.balanceAmount.toStringAsFixed(2);
    balanceAmount.text = salePaymentNavParams.value.balanceAmount.toStringAsFixed(2);
