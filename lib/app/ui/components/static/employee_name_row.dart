                        ...
                        Expanded(
                          child: Container(
                            child: AutoSizeText(
                              ...
                              style: kBaseTextStyle.copyWith(fontSize: 22, fontFamily: arabic, color: AppColors.textBlue),
                    ...
                    children: [
                      Expanded(
                        child: AutoSizeText(
                          ...
                          style: kBaseTextStyle.copyWith(fontSize: 16, fontFamily: arabic, color: Colors.black.withOpacity(.7)),
                          textAlign: TextAlign.right,
                        ),
                      ),
                    ],
